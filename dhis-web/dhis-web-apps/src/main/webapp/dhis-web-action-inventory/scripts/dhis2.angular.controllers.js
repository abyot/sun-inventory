...
.controller('OrgUnitTreeController', function($scope, $modalInstance, OrgUnitFactory, orgUnit) {
    
    $scope.model = {selectedOrgUnitId: orgUnit && orgUnit.id ? orgUnit.id : null};
    ...
    OrgUnitFactory.getViewTreeRoot().then(function(response) {
        ...
        angular.forEach($scope.orgUnits, function(ou){
            ...
            if( orgUnit && orgUnit.id && orgUnit.id === ou.id ){
                selectedOuFetched = true;
            }
            angular.forEach(ou.children, function(o){
                levelsFetched = o.level;
                o.hasChildren = o.children && o.children.length > 0 ? true : false;
                if( orgUnit && orgUnit.id && !selectedOuFetched && orgUnit.id === ou.id ){
                    selectedOuFetched = true;
                }
            });
        });
        ...
        if( orgUnit && orgUnit.id && !selectedOuFetched ){
            var parents = null;
