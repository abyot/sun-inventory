...
.directive('d2OrgUnitTree', function(){
    return {
        restrict: 'E',            
        templateUrl: "views/angular-forms/orgunit-input.html",
        scope: {            
            selectedOrgUnit: '=',
            id: '@',
            d2Object: '=',
        ...
        controller: function($scope, $modal){
            ...
            $scope.showOrgUnitTree = function( orgUnit ){
                
                var modalInstance = $modal.open({
                    templateUrl: "views/angular-forms/orgunit-tree.html",
                    controller: 'OrgUnitTreeController',
                    resolve: {
                        orgUnit: function(){                            
                            return orgUnit ? orgUnit : null;
                        },
                        multiSelect: function(){
                            return $scope.d2MultiSelect;
                        }
                    }
                });

                modalInstance.result.then(function (orgUnit) {
                    if( orgUnit && orgUnit.id ){
                        $scope.d2Object = orgUnit;
